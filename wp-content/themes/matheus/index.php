    ...
    <div class="slides">
      <div class="slide active" data="the history">
        <div class="wrapper">
          ...
          <p style="margin-top:15px;"><span><a href="<?php echo $template_url; ?>/assets/MatheusLiResume2017.pdf" target="_blank">resume</a></span> <span><a href="https://www.linkedin.com/in/mathiouchio" target="_blank">linkedin</a></span></p>
        </div>
      </div>
    </div>
  </section>
